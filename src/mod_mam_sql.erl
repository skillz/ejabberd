...
store(Pkt, LServer, {LUser, LHost}, Type, Peer, Nick, _Dir, TS) ->
    ...
    ejabberd_rdbms:invalidate_subscribed_rooms(SUser, LHost),
    ejabberd_rdbms:invalidate_subscribed_rooms(LPeer, LHost),
     ...
     {archive_msg,
      fun(Host, #archive_msg{us ={LUser, LServer},
          ...
          when LServer == Host ->
                ...
                BarePeer = jid:encode(jid:tolower(jid:remove_resource(Peer))),
                LPeer = jid:encode(jid:tolower(Peer)),
                ejabberd_rdbms:invalidate_subscribed_rooms(SUser, Host),
                ejabberd_rdbms:invalidate_subscribed_rooms(LPeer, Host),
